class Admin::DogsController < ApplicationController
  ...
  def create
    ...
    if @dog.save
      redirect_to admin_dogs_url, notice: 'Dog was successfully created.'
    else
      render :new
    end
  end
  ...
  def update
    if @dog.update(dog_params)
      redirect_to admin_dogs_url, notice: 'Dog was successfully updated.'
    else
      render :edit
    end
  end
  ...
  def destroy
    @dog.destroy
    redirect_to admin_dogs_url, notice: 'Dog was successfully destroyed.'
  end
