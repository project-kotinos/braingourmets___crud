class Admin::EspressosController < ApplicationController
  ...
  def create
    ...
    if @espresso.save
      redirect_to admin_espressos_url, notice: 'Espresso was successfully created.'
    else
      render :new
    end
  end
  ...
  def update
    if @espresso.update(espresso_params)
      redirect_to admin_espressos_url, notice: 'Espresso was successfully updated.'
    else
      render :edit
    end
  end
  ...
  def destroy
    @espresso.destroy
    redirect_to admin_espressos_url, notice: 'Espresso was successfully destroyed.'
  end
